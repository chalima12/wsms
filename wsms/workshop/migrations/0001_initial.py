    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(auto_created=True, choices=[('pending', 'pending'), ('on_prograss', 'On_progress'), ('completed', 'Completed'), ('Not maintainable', 'Not maintanable')], default='pending')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.IntegerField(choices=[('Manager', 'manager'), ('Registeror', 'registeror'), ('Engineer', 'Engineer')], default='Engineer')),
            ],
            options={
                'abstract': False,
            },
