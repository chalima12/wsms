# Generated by Django 4.2.7 on 2024-03-08 09:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('view_item', models.BooleanField(auto_created=True, blank=True, default=False, null=True)),
                ...
                ('user_type', models.CharField(choices=[('Manager', 'manager'), ('Registeror', 'registeror'), ('Engineer', 'Engineer')], default='Engineer', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manager', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='manage_sections', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Notification',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_valid', models.BooleanField(auto_created=True, default=True)),
                ('status', models.CharField(auto_created=True, choices=[('pending', 'pending'), ('Damage', 'Damage'), ('completed', 'Completed')], default='pending', max_length=20)),
                ...
                ('completed_date', models.DateField(blank=True, null=True)),
                ('Section', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sections', to='workshop.section')),
                ('engineer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='engineers', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stock_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='component_stock', to='workshop.stock')),
            ],
        ),
        migrations.AddField(
